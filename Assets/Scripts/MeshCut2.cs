...
public class MeshCut2 : MonoBehaviour
{
	...
	void BoolOn(){
		...
		gameController = GameObject.Find ("OVRCameraRig").GetComponent<GameController>();
	...
	public void Cut ()
	{
		...
		for (int i = 0; i < attachedMesh.triangles.Length; i += 3) {
			...
			if (p1Bool && p2Bool && p3Bool) {
				...
				uv1.Add (cross1Uv);
				normals1.Add (attachedMesh.normals [attachedMesh.triangles [i + n1]]);
				triangles1.Add (vertices1.Count - 4);
			}
		}
...
//		}
		...
		GameObject obj = new GameObject ("cut obj", typeof(MeshFilter), typeof(MeshRenderer), typeof(MeshCollider), typeof(Rigidbody), typeof(MeshCut2));
			var mesh = new Mesh ();
...
//		}
		GameObject obj2 = new GameObject ("cut obj", typeof(MeshFilter), typeof(MeshRenderer), typeof(MeshCollider), typeof(Rigidbody), typeof(MeshCut2));
