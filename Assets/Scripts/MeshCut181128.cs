...
public class MeshCut181128 : MonoBehaviour {
...
//
//				Debug.Log ("errorD");
//				Debug.Log (attachedMesh.triangles.Length);
//				avoidInfCount = 0;
//				return;//kyousei
//			}
//			//メッシュの3つの頂点を取得
...
//				for (int j = i + 1; j < crossVertices.Count; j++) {						
//					if (System.Math.Acos (Vector3.Dot ((crossVertices [0] - crossVertices [1]).normalized, (crossVertices [0] - crossVertices [i]).normalized)) >= System.Math.Acos (Vector3.Dot ((crossVertices [0] - crossVertices [1]).normalized, (crossVertices [0] - crossVertices [j]).normalized))) {
//						if (System.Math.Acos (Vector3.Dot ((crossVertices [0] - crossVertices [1]).normalized, (crossVertices [0] - crossVertices [i]).normalized)) == System.Math.Acos (Vector3.Dot ((crossVertices [0] - crossVertices [1]).normalized, (crossVertices [0] - crossVertices [j]).normalized))) {
//
//
//							if ((crossVertices [0] - crossVertices [i]).magnitude > (crossVertices [0] - crossVertices [j]).magnitude) {
...
//								Debug.Log ("error11-1");
//								for (int k = 0; k < crossVertices.Count; k++) {
//									Debug.Log(crossVertices[k].ToString("F8"));
//								}
//
//								return;//kyousei
//							}
