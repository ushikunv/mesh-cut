...
public class MeshCut3 : MonoBehaviour
{
	...
	public void Cut ()
	{
		...
		GameObject obj = new GameObject ("cut obj", typeof(MeshFilter), typeof(MeshRenderer), typeof(MeshCollider), typeof(Rigidbody), typeof(MeshCut3));
		var mesh = new Mesh ();
		...
		obj.GetComponent<MeshCut3>().skinWidth = skinWidth;
		...
		//		}
		GameObject obj2 = new GameObject ("cut obj", typeof(MeshFilter), typeof(MeshRenderer), typeof(MeshCollider), typeof(Rigidbody), typeof(MeshCut3));
		...
		obj2.GetComponent<MeshCut3>().skinWidth = skinWidth;
